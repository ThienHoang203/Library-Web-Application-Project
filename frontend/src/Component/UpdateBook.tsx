...
export default function UpdateBook({ bookId, setClose }: Props) {
    ...
    return (
        <div className="border-2 bg-white border-black rounded-2xl shadow-[0,0,0,rgba(0,0,0,0.5)] fixed top-[10%] right-[25%] text-center">
            <button
                onClick={() => setClose()}
            ...
            <form noValidate action="#" className="pb-5 px-12 h-fit w-fit" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex">
