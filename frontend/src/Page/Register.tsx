...
export default function Register({ endPoint, redirectPage }: Props) {
    ...
    return (
        <div className="text-center wrapper-login mx-auto my-5 relative w-xl border-2 bg-white border-black rounded-2xl shadow-[0px_0px_20px_rgba(0,0,0,1)]">
            ...
            <form noValidate action="#" className="pb-5 px-12" onSubmit={handleSubmit(onSubmit)}>
                <div className="relative w-full h-[50px] border-b-2 my-[20px]">
                    ...
                    <label htmlFor="name" className="absolute left-2 font-medium -translate-y-1/3  top-[-2px] ">
                        Full Name
                    </label>
                </div>
                ...
                <div className="relative w-full h-[50px] border-b-2 my-[20px]">
                    ...
                    <label htmlFor="username" className="absolute left-2 font-medium -translate-y-1/3 top-[-2px] ">
                        User name
                    </label>
                </div>
                ...
                <div className="relative w-full h-[50px] border-b-2 my-[20px]">
                    ...
                    <label htmlFor="password" className="absolute left-2 font-medium -translate-y-1/3 top-[-2px] ">
                        Password
                    </label>
                </div>
                ...
                <div className="relative w-full h-[50px] border-b-2 my-[20px]">
                    ...
                    />
                    {errors.confirmPassword && <ErrorFormMessage message={errors.confirmPassword.message} />}
                    <label htmlFor="password" className="absolute left-2 font-medium -translate-y-1/3 top-[-2px] ">
                        Confirm Password
                    </label>
                </div>
                ...
                <div className="relative w-full h-[50px] border-b-2 my-[20px]">
                    ...
                    <label htmlFor="email" className="absolute left-2 font-medium -translate-y-1/3 top-[-2px] ">
                        Email
                    </label>
                </div>
                ...
                <div className="relative w-full h-[50px] border-b-2 my-[20px]">
                    ...
                    <label htmlFor="phone" className="absolute left-2 font-medium -translate-y-1/3 top-[-2px] ">
                        Phone Number
                    </label>
                </div>
