...
export default function Single() {
  ...
  useEffect(() => {
    ...
    const totalRatingPoint = book.ratings.reduce(
      (total, item) => total + item.rating,
      0
    );

    setAverageRating(
      Math.ceil((totalRatingPoint * 100) / book.ratings.length) / 100
    );
  }, [params?.bookId, location]);
      ...
      <div className=" text-left w-full " ref={sectionRef}>
        ...
        <div className="pl-6 mb-4">
          <div className=" text-center">
            <h3
              data-x-text="`${book.review_count} đánh giá`"
              ...
              <div className="flex items-center">
                ...
                <div className="flex space-x-4 text-xs text-gray-300">
                  <div className="flex items-center">
                    ...
                    <span
                      data-x-text="review.average_score"
                      className="ml-1 mt-1"
                    >
                      {item.rating}
                    </span>
